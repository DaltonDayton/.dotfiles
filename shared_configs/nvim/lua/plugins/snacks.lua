return {
  ...
  keys = {
    ...
    { "<leader>fh", function() Snacks.picker.files({ hidden = true, ignored = true }) end, desc = "Find Hidden/Ignored Files" },
  ...
  init = function()
    vim.api.nvim_create_autocmd("User", {
      ...
      callback = function()
        ...
        -- stylua: ignore start
        -- Create some toggle mappings (moved to <leader>u for UI Toggles)
        Snacks.toggle.option("spell", { name = "Spelling" }):map("<leader>usp")
        Snacks.toggle.option("wrap", { name = "Wrap" }):map("<leader>uw")
        Snacks.toggle.option("relativenumber", { name = "Relative Number" }):map("<leader>uR")
        Snacks.toggle.diagnostics():map("<leader>ud")
        Snacks.toggle.line_number():map("<leader>uln")
